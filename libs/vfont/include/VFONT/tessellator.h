...
protected:
    ...
    static std::set<uint32_t> _resolveIntersectingEdges(std::vector<glm::vec2> &vertices,
                                                        std::vector<vft::Edge> &edges);
    static double _determinant(double a, double b, double c, double d);
    static bool _intersect(const std::vector<glm::vec2> &vertices,
                           vft::Edge first,
                           vft::Edge second,
    ...
    static void _resolveSharedVertices(std::vector<glm::vec2> &vertices,
                                       std::vector<vft::Edge> &edges,
                                       std::set<uint32_t> &intersections);
    static void _walkContours(const std::vector<glm::vec2> &vertices,
                              std::vector<vft::Edge> &edges,
                              std::set<uint32_t> intersections);
    static std::vector<uint32_t> _getEdgesStartingAt(uint32_t vertexId, const std::vector<vft::Edge> &edges);
    static void _visitEdgesUntilIntersection(std::vector<vft::Edge> &edges,
