...
EditorScene::EditorScene(CameraType cameraType) : Scene{cameraType} {
    this->_arial32 = std::make_shared<Font>(EditorScene::ARIAL_PATH, 32);
    this->_textBlock = std::make_shared<TextBlock>(this->_arial32, glm::vec3(1.f, 1.f, 1.f), glm::vec3(0.f, 0.f, 0.f), -1, true);
    TextRenderer::getInstance().add(this->_textBlock);
